...
namespace ClassLibrary1 {
   public class Adresbeheer {
        ...
        private static List<Adres> GMLParser() {
            ...
            XDocument doc = XDocument.Load(@"D:\Hogent\Test\CRAB_Adressenlijst_GML\GML\CrabAdr.gml");
        ...
        //            //Gemeente
        //            BulkGemeente(connection, adapter, adresses);
        //            //Straatnaam
        ...
        //}
                    ...
                    //    string queryLocatie = "SELECT * FROM adreslocatie";
                    ...
                    //    string queryGemeente = "SELECT * FROM gemeente";
                    ...
                    //    string queryStraatnaam = "SELECT * FROM straatnaam";
                    ...
                    //    string queryAdres = "SELECT * FROM adres";
            ...
            DbConnection connection = getConnection();
            string queryAdres = "INSERT INTO adres(ID,straatnaamID,huisnummer,appartementnummer,busnummer,huisnummerlabel,adreslocatieID) output INSERTED.ID " +
                "VALUES(@ID,@straatnaamID,@huisnummer,@appartementnummer,@busnummer,@huisnummerlabel,@adreslocatieID)";
            string queryAdresLocatie = "INSERT INTO adreslocatie(Id,x,y) output INSERTED.Id " +
                "VALUES(@Id,@x,@y)";
        ...
        private int NewLocatieID(DbConnection connection) {
            string query = "SELECT COUNT(adreslocatie.Id) as count FROM adreslocatie";
            int toReturn = 0;
